...
### 2.2. 工作路径
**此文档工作路径设置为 <font color="#dd0000">/bsn</font>**，如果工作路径设置非 **<font color="#dd0000">/bsn</font>** 请修改相关docker-compose.yml启动文件
...
services:
  mysql:
    ...
    ports:
      - 3306:3306
    volumes:
      - /bsn/data:/var/lib/mysql
      - /bsn/conf/my.cnf:/etc/mysql/my.cnf
      - /bsn/script:/mysql-script
    command:
...
services:
  nacos:
    ...
    environment:
      ...
      - MODE=standalone
    volumes:
      - /bsn/logs/:/home/nacos/logs
      - /bsn/plugins/:/home/nacos/plugins
      - /bsn/data/:/home/nacos/data
      - /bsn/conf/application.properties:/home/nacos/conf/application.properties
EOF
...
```shell
mkdir -p /bsn/redis/{conf,data,logs}
...
services:
  redis:
    ...
    volumes:
      - /bsn/data:/data
      - /bsn/conf/redis.conf:/etc/redis/redis.conf
      - /bsn/logs:/logs
    ports:
      - 6379:6379
    command:
...
# 修改start.sh启动脚本
bash /bsn/set-nacos-address.sh
# 手动输入
Please enter the nacos server address: <nacos服务器IP地址>
...
services:
  ddc-chainsrv-<ChainName>-service:
    ...
    #   - 32020:32020
    volumes:
      - /bsn/pkg/ddc-chainsrv-<ChainName>.jar:/bsn/chainService/ROOT.jar
      - /bsn/ddclogs/:/bsn/ddclogs
      - /bsn/script/:/bsn/script
      - /etc/hosts:/etc/hosts
...
services:
  ddc-<service_name>-service:
    ...
    #   - 38021:38021
    volumes:
      - /bsn/pkg/ddc-<service_name>.jar:/bsn/ddc-<service_name>/ROOT.jar
      - /bsn/ddclogs/:/bsn/ddclogs/
      - /bsn/script/:/bsn/script
      - /etc/hosts:/etc/hosts
      - /etc/localtime:/etc/localtime
...
services:
  ddc-oai-service:
    ...
    #   - 18080:18080
    volumes:
      - /bsn/pkg/ddc-oai.jar:/bsn/ddc-oai/ROOT.jar
      - /bsn/ddclogs/:/bsn/ddclogs/
      - /bsn/script/:/bsn/script
      - /etc/hosts:/etc/hosts
      - /etc/localtime:/etc/localtime
...
EOF
# 将启动的jar包放至pkg目录
# 将start.sh放至/bsn/ddc-oai/script/ 下，注意修改nacos服务器地址+端口号
...
# /bsn/operesty-nginx/docker-comopse.yml
...
    ports:
      # - "80:80"
      # - "443:443"
...
services:
  nginx:
    ...
    restart: always
    volumes:
      - /bsn/conf/nginx.conf:/usr/local/openresty/nginx/conf/nginx.conf
      - /bsn/conf/ip_white.conf:/usr/local/openresty/nginx/conf/ip_white.conf
      - /bsn/stream:/etc/nginx/conf.d
      - /bsn/logs:/var/log/
      - /bsn/ssl:/etc/nginx/ssl
      - /etc/hosts:/etc/hosts
      - /bsn/html/operation/dist:/usr/local/openresty/nginx/html/operation
      - /bsn/html/portal/dist:/usr/local/openresty/nginx/html/portal
    ports:
